...
def token_required(f):
    ...
    def decorator(*args, **kwargs):
        ...
        # For JWT Bearer Token implementation see here:
...
def create_author(current_user):
    ...
    new_authors = Authors(name=data['name'], country=data['country'],
                          book=data['book'], booker_prize=True, user_id=current_user.id)
